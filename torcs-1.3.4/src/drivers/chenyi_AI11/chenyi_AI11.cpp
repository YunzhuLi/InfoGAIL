/***************************************************************************
    ...
    file                 : chenyi_AI11.cpp
    created              : 2014年 09月 12日 星期五 12:18:28 EDT
 ...
 */ 
extern "C" int 
chenyi_AI11(tModInfo *modInfo) 
{
    memset(modInfo, 0, 10*sizeof(tModInfo));

    modInfo->name    = strdup("chenyi_AI11");		/* name of the module (short) */
