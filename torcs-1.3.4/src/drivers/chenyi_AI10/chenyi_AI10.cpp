/***************************************************************************
    ...
    file                 : chenyi_AI10.cpp
    created              : 2014年 09月 01日 星期一 13:08:58 EDT
 ...
 */ 
extern "C" int 
chenyi_AI10(tModInfo *modInfo) 
{
    memset(modInfo, 0, 10*sizeof(tModInfo));

    modInfo->name    = strdup("chenyi_AI10");		/* name of the module (short) */
