...
//////// Yunzhu ////////
double __SENSORS_RANGE__ = 200;
int MAX_STEP_LIMIT = 200;
int PRE_STEP_COUNT = 120;
int IMG_WIDTH = 320;
int IMG_HEIGHT = 240;
FILE *f_record;
static int step_count;
static Sensors *trackSens_yz;
static ObstacleSensors *oppSens_yz;
static float trackSensAngle_yz[19] = {
    -90, -75, -60, -45, -30, -20, -15, -10, -5, 0, 5, 10, 15, 20, 30, 45, 60, 75, 90
};

static float pre_actions[120][3] = {
	{0.006339, 0.196744, 0.000000},
	{0.006675, 0.200742, 0.000000},
	{0.006675, 0.200742, 0.000000},
	{0.006675, 0.200742, 0.000000},
	{0.006675, 0.200742, 0.000000},
	{0.006675, 0.200742, 0.000000},
	{0.011137, 0.244948, 0.000000},
	{0.013147, 0.269051, 0.000000},
	{0.018480, 0.285082, 0.000000},
	{0.050812, 0.289118, 0.000000},
	{0.065950, 0.297152, 0.000000},
	{0.085504, 0.321217, 0.000000},
	{0.110505, 0.369422, 0.000000},
	{0.162956, 0.389489, 0.000000},
	{0.165211, 0.413591, 0.000000},
	{0.178665, 0.429659, 0.000000},
	{0.195807, 0.437656, 0.000000},
	{0.213955, 0.445691, 0.000000},
	{0.243451, 0.457723, 0.000000},
	{0.275332, 0.465757, 0.000000},
	{0.270651, 0.477827, 0.000000},
	{0.269794, 0.477827, 0.000000},
	{0.268930, 0.477827, 0.000000},
	{0.268023, 0.477827, 0.000000},
	{0.267158, 0.477827, 0.000000},
	{0.266267, 0.477827, 0.000000},
	{0.265340, 0.477827, 0.000000},
	{0.264420, 0.477827, 0.000000},
	{0.274532, 0.485824, 0.000000},
	{0.258845, 0.489860, 0.000000},
	{0.204701, 0.493895, 0.000000},
	{0.058892, 0.493895, 0.000000},
	{0.010347, 0.493895, 0.000000},
	{0.002539, 0.493895, 0.000000},
	{0.000006, 0.489860, 0.000000},
	{-0.000000, 0.489860, 0.000000},
	{-0.001292, 0.485824, 0.000000},
	{-0.008583, 0.485824, 0.000000},
	{-0.041432, 0.485824, 0.000000},
	{-0.091408, 0.485824, 0.000000},
	{-0.166506, 0.485824, 0.000000},
	{-0.165926, 0.485824, 0.000000},
	{-0.203890, 0.485824, 0.000000},
	{-0.213682, 0.485824, 0.000000},
	{-0.223733, 0.485824, 0.000000},
	{-0.230384, 0.485824, 0.000000},
	{-0.256489, 0.485824, 0.000000},
	{-0.255738, 0.485824, 0.000000},
	{-0.007454, 0.481863, 0.000000},
	{0.000356, 0.477827, 0.000000},
	{0.011020, 0.473829, 0.000000},
	{0.046491, 0.469793, 0.000000},
	{0.098437, 0.461759, 0.000000},
	{0.107772, 0.461759, 0.000000},
	{0.107548, 0.461759, 0.000000},
	{0.017103, 0.413591, 0.000000},
	{0.000968, 0.373420, 0.000000},
	{0.000055, 0.373420, 0.000000},
	{-0.000000, 0.377456, 0.000000},
	{-0.000000, 0.377456, 0.000000},
	{-0.000000, 0.377456, 0.000000},
	{0.000006, 0.381455, 0.000000},
	{0.000109, 0.373420, 0.000000},
	{-0.000000, 0.373420, 0.000000},
	{-0.000613, 0.377456, 0.000000},
	{-0.002620, 0.369422, 0.000000},
	{-0.009294, 0.365386, 0.000000},
	{-0.010218, 0.341321, 0.000000},
	{-0.010207, 0.329251, 0.000000},
	{-0.010198, 0.317219, 0.000000},
	{-0.010673, 0.293116, 0.000000},
	{-0.010666, 0.293116, 0.000000},
	{-0.010175, 0.281046, 0.000000},
	{-0.009696, 0.240913, 0.000000},
	{-0.009693, 0.240913, 0.000000},
	{-0.009691, 0.240913, 0.000000},
	{-0.009688, 0.240913, 0.000000},
	{-0.004796, 0.228843, 0.000000},
	{-0.000687, 0.232879, 0.000000},
	{-0.000142, 0.224845, 0.000000},
	{-0.000018, 0.220809, 0.000000},
	{-0.000000, 0.220809, 0.000000},
	{-0.000000, 0.220809, 0.000000},
	{-0.000000, 0.224845, 0.000000},
	{-0.000000, 0.224845, 0.000000},
	{-0.000001, 0.224845, 0.000000},
	{-0.001074, 0.224845, 0.000000},
	{-0.005090, 0.224845, 0.000000},
	{-0.026296, 0.224845, 0.000000},
	{-0.038407, 0.224845, 0.000000},
	{-0.038403, 0.224845, 0.000000},
	{-0.038400, 0.220809, 0.000000},
	{-0.038398, 0.220809, 0.000000},
	{-0.038396, 0.220809, 0.000000},
	{-0.038394, 0.204778, 0.000000},
	{-0.053650, 0.200742, 0.000000},
	{-0.057997, 0.200742, 0.000000},
	{-0.058004, 0.200742, 0.000000},
	{-0.058011, 0.200742, 0.000000},
	{-0.058018, 0.200742, 0.000000},
	{-0.058022, 0.200742, 0.000000},
	{-0.058024, 0.200742, 0.000000},
	{-0.058023, 0.200742, 0.000000},
	{-0.015062, 0.188710, 0.000000},
	{-0.006406, 0.188710, 0.000000},
	{-0.005399, 0.188710, 0.000000},
	{-0.005399, 0.188710, 0.000000},
	{-0.026301, 0.192745, 0.000000},
	{-0.039568, 0.192745, 0.000000},
	{-0.039569, 0.192745, 0.000000},
	{-0.025421, 0.188710, 0.000000},
	{-0.001074, 0.188710, 0.000000},
	{-0.000607, 0.188710, 0.000000},
	{-0.000607, 0.188710, 0.000000},
	{-0.000866, 0.192745, 0.000000},
	{-0.004790, 0.188710, 0.000000},
	{-0.013856, 0.188710, 0.000000},
	{-0.017663, 0.188710, 0.000000},
	{-0.017662, 0.188710, 0.000000},
	{-0.001074, 0.188710, 0.000000}
};
//////// Yunzhu ////////
...
void newrace(int index, tCarElt* car, tSituation *s)
{
	...
	//////// Yunzhu ////////
	f_record = fopen("/home/yunzhu/Desktop/human_low_case_1/demo/human_demo.txt", "w");
	step_count = 0;
	// Init track sensors
	trackSens_yz = new Sensors(car, 19);
	for (int i = 0; i < 19; i++) {
	    trackSens_yz->setSensor(i, trackSensAngle_yz[i], __SENSORS_RANGE__);
	    printf("Set Track Sensors %d at anlge %lf\n", i + 1, trackSensAngle_yz[i]);
	}
	// Init opponents sensors
	oppSens_yz = new ObstacleSensors(36, curTrack, car, s, (int) __SENSORS_RANGE__);
	//////// Yunzhu ////////
}
...
static void common_drive(int index, tCarElt* car, tSituation *s)
{
	...
	//////// Yunzhu ////////
	// Feature: [angle(1), damage(1), rpm(1), trackPos(1), speedX(1), speedY(1), speedZ(1), wheelSpinVel(4), trackSensor(19), oppSensor(36)]
	// Action: [steer(1), accel(1), brake(1)]
	if (step_count < MAX_STEP_LIMIT) {
	    if (step_count < PRE_STEP_COUNT) {
		car->_steerCmd = pre_actions[step_count][0];
		car->_accelCmd = pre_actions[step_count][1];
		car->_brakeCmd = pre_actions[step_count][2];
	    }
	    float angle_yz = RtTrackSideTgAngleL(&(car->_trkPos)) - car->_yaw;
	    float damage_yz = car->_dammage;
	    float rpm_yz = car->_enginerpm;
	    float trackPos_yz = 2*car->_trkPos.toMiddle/(car->_trkPos.seg->width);
	    float speedX_yz = float(car->_speed_x * 3.6);
	    float speedY_yz = float(car->_speed_y * 3.6);
	    float speedZ_yz = float(car->_speed_z * 3.6);
	    float wheelSpinVel_yz[4];
	    for (int i = 0; i < 4; i++)
	        wheelSpinVel_yz[i] = car->_wheelSpinVel(i);
	
	    printf("Step: %d, Damage: %.2lf, Dist: %.2lf, TrackPos: %.4lf, Action: %.4lf %.4lf %.4lf, SpeedX: %.2lf\n", 
		step_count, damage_yz, car->race.distFromStartLine, trackPos_yz, car->_steerCmd, car->_accelCmd, car->_brakeCmd, speedX_yz);
	
	    const int BUFSIZE = 1024;
	    char buf[BUFSIZE];
	    snprintf(buf, BUFSIZE, "/home/yunzhu/Desktop/human_low_case_1/demo/capture-%d.png", step_count);
	    GfImgWritePng(car->img, buf, IMG_WIDTH, IMG_HEIGHT);
	    free(car->img), car->img = NULL;

	    fprintf(f_record, "%lf %lf %lf %lf %lf %lf %lf ", \
		angle_yz, damage_yz, rpm_yz, trackPos_yz, speedX_yz, speedY_yz, speedZ_yz);
	    for (int i = 0; i < 4; i++)
	        fprintf(f_record, "%lf ", wheelSpinVel_yz[i]);
	
	    // track sensor
	    float trackSensorOut_yz[19];
	    if (trackPos_yz <= 1.0 && trackPos_yz >= -1.0) {
	        trackSens_yz->sensors_update();
	        for (int i = 0; i < 19; i++) {
		    trackSensorOut_yz[i] = trackSens_yz->getSensorOut(i);
	        }
	    }
	    else {
	        for (int i = 0; i < 19; i++)
		    trackSensorOut_yz[i] = -1;
	    }

	    for (int i = 0; i < 19; i++)
	        fprintf(f_record, "%lf ", trackSensorOut_yz[i]);

	    // opponent sensor
	    float oppSensorOut_yz[36];
	    oppSens_yz->sensors_update(s);
	    for (int i = 0; i < 36; i++) {
	        oppSensorOut_yz[i] = oppSens_yz->getObstacleSensorOut(i);
	    }

	    for (int i = 0; i < 36; i++)
	        fprintf(f_record, "%lf ", oppSensorOut_yz[i]);

	    fprintf(f_record, "%lf %lf %lf\n", car->_steerCmd, car->_accelCmd, car->_brakeCmd);

	    if (step_count + 1 == MAX_STEP_LIMIT) {
		printf("State & action recording finished.\n");
		fclose(f_record);
	    }
