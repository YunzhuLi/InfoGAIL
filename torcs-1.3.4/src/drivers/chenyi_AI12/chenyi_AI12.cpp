/***************************************************************************
    ...
    file                 : chenyi_AI12.cpp
    created              : 2014年 09月 12日 星期五 12:18:21 EDT
 ...
 */ 
extern "C" int 
chenyi_AI12(tModInfo *modInfo) 
{
    memset(modInfo, 0, 10*sizeof(tModInfo));

    modInfo->name    = strdup("chenyi_AI12");		/* name of the module (short) */
